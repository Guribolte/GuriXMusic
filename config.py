...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "Guri ダ Music")
...
CLEANMODE_DELETE_MINS = int(getenv("CLEANMODE_MINS", "240"))
...
STATS_IMG_URL = "https://telegra.ph//file/d59b32fdd383f72b8b53d.jpg"
